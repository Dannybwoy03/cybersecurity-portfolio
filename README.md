# Daniel Agyemang-Badu — Cybersecurity Portfolio
...
|---|---------|-------------------|--------|
| 1 | Phishing Email Analysis | Email forensics, IOC extraction | 🔄 Coming Soon |
| 2 | Kali Linux Network Scan | Nmap, reconnaissance | 🔄 Coming Soon |
| 3 | Vulnerability Scan Report | OpenVAS, risk analysis | 🔄 Coming Soon |
| 4 | Malicious Traffic Analysis | Wireshark, PCAP analysis | 🔄 Coming Soon |
